...
namespace KinhDoanhThuCung.Models
{
    ...
    partial void DeleteTHUCUNG(THUCUNG instance);
		...
		public ThuCungDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CHTCConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnDONGIAChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MATC", DbType="VarChar(5)")]
		public string MATC
		{
			get
			{
			...
			set
			{
							...
							|| (this._HOADON.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CTHOADONTHUCUNG = null;
					}
					this._HOADON.Entity = value;
					if ((value != null))
					{
						value.CTHOADONTHUCUNG = this;
	...
	public partial class HOADON : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<CTHOADONTHUCUNG> _CTHOADONTHUCUNG;
    ...
    partial void OnMAKMChanged();
		...
		public HOADON()
		{
			this._CTHOADONTHUCUNG = default(EntityRef<CTHOADONTHUCUNG>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HOADON_CTHOADONTHUCUNG", Storage="_CTHOADONTHUCUNG", ThisKey="MAHD", OtherKey="MAHD", IsUnique=true, IsForeignKey=false)]
		public CTHOADONTHUCUNG CTHOADONTHUCUNG
		{
			get
			{
				return this._CTHOADONTHUCUNG.Entity;
			}
			set
			{
				CTHOADONTHUCUNG previousValue = this._CTHOADONTHUCUNG.Entity;
				if (((previousValue != value) 
							|| (this._CTHOADONTHUCUNG.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CTHOADONTHUCUNG.Entity = null;
						previousValue.HOADON = null;
					}
					this._CTHOADONTHUCUNG.Entity = value;
					if ((value != null))
					{
						value.HOADON = this;
					}
					this.SendPropertyChanged("CTHOADONTHUCUNG");
				}
			}
		}
